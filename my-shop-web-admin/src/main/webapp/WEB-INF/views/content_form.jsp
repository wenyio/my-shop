                        ...
                        <form:form id="inputForm" cssClass="form-horizontal" action="/content/save" method="post" modelAttribute="tbContent">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input class="form-control required" path="title" placeholder="标题" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input class="form-control required" path="subTitle" placeholder="子标题" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input class="form-control required" path="titleDesc" placeholder="标题描述" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input class="form-control required" path="url" placeholder="链接" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input class="form-control required" path="pic2" placeholder="图片2" />
                            ...
                            <div class="box-footer">
                                ...
                                <button id="btnSubmit" type="submit" class="btn btn-info pull-right">保存</button>
                            </div>
                        </form:form>
                    </div>
                </div>
